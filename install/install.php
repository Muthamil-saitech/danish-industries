...
switch ($step) {
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="bottom">
                        ...
                        <?php } else { ?>
                            <a href="<?php echo $base_url?>index.php?step=2" class="btn btn-primary button_1">Next<i class="fa fa-angle-double-right right_arrow"></i></a>
                        <?php } ?>
                    </div>
                </div>
            </div>
    ...
    case "0": ?>
        ...
        if ($_POST) {
            ...
            $purchase_code = "6bde9669-4c5b-444b-9e6d-4451a17a8455";
            $username = "sridharsaitech";
            $owner = $_POST["owner"];
            //need to change
            $source = 'CodeCanyon';
            //need to change
        ...
        <div class="panel panel-default">
            ...
            if ($_POST) {
                ...
                <form action="<?php echo $base_url?>index.php?step=2" method="POST" class="form-horizontal">
                    ...
                    <input id="purchase_code" type="hidden" name="purchase_code" value="6bde9669-4c5b-444b-9e6d-4451a17a8455" />
                    <input type="hidden" name="username" value="sridharsaitech" />
                    <div class="bottom">
                        <button type="submit" class="btn btn-primary button_1">Next<i class="fa fa-angle-double-right right_arrow"></i></button>
                    </div>
                </form>
                ...
                <div class="panel-body">
                    ...
                    <div class="bottom bottom_config">
                        <form action="<?php echo $base_url?>index.php?step=1" method="POST" class="form-horizontal config_form">
                            <input id="purchase_code" type="hidden" name="purchase_code" value="6bde9669-4c5b-444b-9e6d-4451a17a8455" />
                            <input id="username" type="hidden" name="username" value="sridharsaitech" />
    ...
    case "3":
        ...
        if ($_POST) {
            ...
            <form action="<?php echo $base_url?>index.php?step=4" method="POST" class="form-horizontal">
                ...
                <input type="hidden" name="purchase_code" value="6bde9669-4c5b-444b-9e6d-4451a17a8455" />
                <input type="hidden" name="username" value="sridharsaitech" />
                <div class="bottom bottom_config">
