    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Sales List: <?php echo e(isset($obj) ? count($obj) : '0'); ?> </h5>
            </div>
        </div>
    </section>
                ...
                <table id="datatable" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <h6><?php if($value->receive_status=="Paid"): ?> <span class="badge bg-success">Paid</span> <?php elseif($value->receive_status=="Initiated"): ?> <span class="badge bg-danger">Initiated</span> <?php else: ?> <span class="badge bg-info">Partially Paid</span><?php endif; ?></h6>
                            </td>
                            <td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo app('translator')->get('index.sales_list'); ?></h5>
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                <?php echo Form::text('startDate', (isset($startDate)&&$startDate!='') ? date('d-m-Y',strtotime($startDate)) : '', ['class' => 'form-control', 'readonly'=>"", 'placeholder'=>"Start Date", 'id' => 's_start_date']); ?>

                            </div>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                <?php echo Form::text('endDate', (isset($endDate)&&$endDate!='') ? date('d-m-Y',strtotime($endDate)) : '', ['class' => 'form-control', 'readonly'=>"", 'placeholder'=>"End Date", 'id' => 's_complete_date']); ?>
                        ...
                        <div class="col-md-4 mt-3">
                            <a href="<?php echo e(route('sales.index')); ?>" style="text-decoration: none;color:white;"><button type="button" value="reset" class="btn bg-second-btn w-100">Reset</button></a>
                        </div>
                    </div>
                </div>
                <?php echo Form::close(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/sales/sales.blade.php ENDPATH**/ ?>