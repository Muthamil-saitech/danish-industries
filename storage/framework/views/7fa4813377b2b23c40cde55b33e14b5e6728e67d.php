                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="w-50 text-right">
                                        ...
                                        <p class="pb-7 rgb-71">
                                            <span class=""><strong><?php echo app('translator')->get('index.area'); ?>:</strong></span>
                                            <?php echo e($obj->area); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish\resources\views/pages/customer/viewDetails.blade.php ENDPATH**/ ?>