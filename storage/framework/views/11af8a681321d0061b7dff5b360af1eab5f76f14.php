                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><h6><?php if($value->orderInvoice->due_amount==0.00): ?> <span class="badge bg-success">Paid</span> <?php elseif($value->orderInvoice->paid_amount==0.00): ?> <span class="badge bg-danger">Unpaid</span> <?php else: ?> <span class="badge bg-info">Partially Paid</span><?php endif; ?></h6></td>
                                    <td class="text-end">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish\resources\views/pages/customer_payment/index.blade.php ENDPATH**/ ?>