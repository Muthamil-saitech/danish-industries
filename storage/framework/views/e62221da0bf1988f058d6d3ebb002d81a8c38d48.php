        ...
        <section class="content-header">
            <div class="row">
                ...
                <div class="col-md-6 text-end">
                    <h5 class="mb-0">Total Payroll: <?php echo e(isset($obj) ? count($obj) : '0'); ?> </h5>
                </div>
            </div>
        </section>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($value->total_amount!='' ? '₹'.number_format($value->total_amount,2) : '₹0.00'); ?></td>
                                    <td><?php echo e($value->addedBy->name ?? ''); ?></td>
                                    <td class="ir_txt_center">
                                        <?php if(routePermission('payroll.edit')): ?>
                                            <a href="<?php echo e(url('payroll')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit" class="button-success"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="<?php echo app('translator')->get('index.edit'); ?>"><i class="fa fa-edit tiny-icon"></i></a>
                                        <?php endif; ?>
                                        <?php if(routePermission('payroll.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('payroll.destroy', $value->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/payroll/index.blade.php ENDPATH**/ ?>