        ...
        <section class="content-header">
            <div class="row">
                ...
                <div class="col-md-6 text-end">
                    <h5 class="mb-0">Total Expense Categories: <?php echo e(isset($obj) ? count($obj) : '0'); ?> </h5>
                </div>
            </div>
        </section>
                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="w-40"><?php echo app('translator')->get('index.description'); ?></th>
                                <th class="w-15"><?php echo app('translator')->get('index.added_by'); ?></th>
                                <th class="w-10 ir_txt_center"><?php echo app('translator')->get('index.actions'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(safe($value->description)); ?></td>
                                    <td><?php echo e($value->addedBy->name); ?></td>
                                    <td class="ir_txt_center">
                                        <?php if(routePermission('expense-category.edit')): ?>
                                            <a href="<?php echo e(url('expense-category')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit"
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('expense-category.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('expense-category.destroy', $value->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/expense_category/index.blade.php ENDPATH**/ ?>