    ...
    <section class="content-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Customers: <?php echo e($total_customers); ?> </h5>
            </div>
        </div>
    </section>
                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="width_1_p"><?php echo app('translator')->get('index.cust_id'); ?></th>
                            
                            <th class="width_10_p"><?php echo app('translator')->get('index.customer_name'); ?></th>
                            ...
                            <th class="width_10_p"><?php echo app('translator')->get('index.pan_no'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td title="<?php echo e($value->address); ?>"><?php echo e(substr_text(safe($value->address),20)); ?></td>
                            <td><?php echo e(safe($value->gst_no)); ?></td>
                            <td><?php echo e(safe($value->pan_no)); ?></td>
                            <td><?php echo e(safe($value->ecc_no)); ?></td>
                            <td><?php echo e(safe($value->area)); ?></td>
                            <td><?php echo e(getUserName($value->added_by)); ?></td>
                            <td><?php echo e(getDateFormat($value->created_at)); ?></td>
                            <td class="text-start">
                                <a href="<?php echo e(route('customers.show', encrypt_decrypt($value->id, 'encrypt'))); ?>"
                                ...
                                <?php endif; ?>
                                <?php if(routePermission('customer.delete') && !$value->used_in_stock_or_orders): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/customer/customers.blade.php ENDPATH**/ ?>