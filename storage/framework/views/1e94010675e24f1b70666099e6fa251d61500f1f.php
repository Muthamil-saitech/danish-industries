                                        ...
                                        <table class="table table-striped">
                                            <thead class="b-r-3 bg-color-000000">
                                                <tr>
                                                    ...
                                                    <th class="w-30 text-start"><?php echo app('translator')->get('index.challan_no'); ?><br>(DC Date)</th>
                                                    <th class="w-30 text-start"><?php echo app('translator')->get('index.doc_no'); ?></th>
                                                    ...
                                                    <th class="w-15 text-start"><?php echo app('translator')->get('index.mat_price'); ?></th>
                                                    <th class="w-30 text-start"><?php echo app('translator')->get('index.hsn_no'); ?></th>
                                            ...
                                            <tbody>
                                                <tr class="rowCount">
                                                    ...
                                                    <td class="text-start"><?php echo e($material_stock->material_price!='0' ? '₹'.$material_stock->material_price : ''); ?></td>
                                                    <td class="text-start"><?php echo e($material_stock->hsn_no); ?></td>
                                    ...
                                    <?php if(isset($stock_adjustments) && $stock_adjustments): ?>
                                        ...
                                        <?php $__currentLoopData = $stock_adjustments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="rowCount">
                                                ...
                                                <td class="text-start"><?php echo e($value->material_price!='0' ? '₹'.$value->material_price : ''); ?></td>
                                                <td class="text-start"><?php echo e($value->hsn_no); ?></td>
