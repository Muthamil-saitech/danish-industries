...
<body>
    <div class="m-auto b-r-5 p-30">
        <table>
            <tr>
                ...
                <td class="w-50 text-right">
                    <img src="<?php echo getBaseURL() . (isset(getWhiteLabelInfo()->logo) ? 'uploads/white_label/' . getWhiteLabelInfo()->logo : 'images/logo.png'); ?>" alt="site-logo">
                </td>
            </tr>
        </table>
        ...
        <h4><?php echo app('translator')->get('index.raw_material_consumption_cost'); ?> (RoM)</h4>
        <table class="w-100 mt-10 manufacture_table">
            ...
            <tbody>
                ...
                <tr class="rowCount">
                    ...
                    <td class="text-start"><?php echo e($value->consumption); ?> <?php echo e(getStockUnitById($value->stock_id)); ?></td>
                </tr>
        ...
        <h4 class="mt-20"><?php echo app('translator')->get('index.manufacture_stages'); ?></h4>
        <table class="w-100 mt-10 production_table">
            ...
            <tbody>
                ...
                <tr class="rowCount">
                    ...
                    <td class="text-left">
                        <?php echo e(getProductionStages($value->productionstage_id)); ?>

                    </td>
                    <td class="text-center"><?php echo e($value->stage_hours); ?></td>
                    <td class="text-center"><?php echo e($value->stage_minute); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td class="text-center">
                        <?php echo e(isset($total_hours) && $total_hours ? $total_hours : ''); ?>
