    ...
    <section class="content-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Inspections: <?php echo e($total_inspections); ?> </h5>
            </div>
        </div>
    </section>
                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="ir_w_16"><?php echo app('translator')->get('index.mat_type'); ?></th>
                            <th class="ir_w_16"><?php echo app('translator')->get('index.material_name'); ?> (Code)</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($value->mat_type==1 ? 'Raw Material' : 'Insert'); ?></td>
                            <td><?php echo e(getRMName($value->mat_id)); ?></td>
                            
                            
                            <td><?php echo e(getDrawerNo($value->drawer_id)); ?></td>
                            <td class="text-start">
                                <?php if(routePermission('inspections.edit')): ?>
                                <a href="<?php echo e(url('inspections')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit" class="button-success" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('index.edit'); ?>"><i class="fa fa-edit tiny-icon"></i></a>
                                <?php endif; ?>
                                <?php if(routePermission('inspections.delete') && !$value->used_in_dimension): ?>
                                <a href="#" class="delete button-danger"
                                    ...
                                    <form action="<?php echo e(route('inspections.destroy', $value->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/inspection/inspection.blade.php ENDPATH**/ ?>