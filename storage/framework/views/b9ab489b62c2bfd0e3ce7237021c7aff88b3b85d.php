    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Supplier Purchases: <?php echo e($total_supplier_purchase); ?> </h5>
            </div>
        </div>
    </section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/purchase/purchases.blade.php ENDPATH**/ ?>