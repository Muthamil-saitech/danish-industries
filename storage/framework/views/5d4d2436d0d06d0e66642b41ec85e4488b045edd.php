    ...
    <section class="content-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Product Categories: <?php echo e($total_fpcategories); ?> </h5>
            </div>
        </div>
    </section>
                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="width_20_p"><?php echo app('translator')->get('index.product_category'); ?></th>
                            <th class="width_20_p"><?php echo app('translator')->get('index.description'); ?></th>
                            <th class="width_10_p text-start"><?php echo app('translator')->get('index.actions'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span title="<?php echo e($value->description); ?>"><?php echo e(safe(substr_text($value->description,50))); ?></span></td>
                            <td class="text-start">
                                <?php if(routePermission('productcategory.edit')): ?>
                                <a href="<?php echo e(url('fpcategories')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit"
                                ...
                                <?php endif; ?>
                                <?php if(routePermission('productcategory.delete') && !$value->used_in_product): ?>
                                <a href="#" class="delete button-danger"
                                    ...
                                    <form action="<?php echo e(route('fpcategories.destroy', $value->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/fpcategory/fpcategories.blade.php ENDPATH**/ ?>