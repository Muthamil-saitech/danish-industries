        ...
        <section class="content-header">
            <div class="row">
                ...
                <div class="col-md-6 text-end">
                    <h5 class="mb-0">Total Deposits: <?php echo e(isset($obj) ? count($obj) : '0'); ?> </h5>
                </div>
            </div>
        </section>
                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_10_p"><?php echo app('translator')->get('index.transaction_date'); ?></th>
                                <th class="width_10_p"><?php echo app('translator')->get('index.amount'); ?></th>
                                <th class="width_10_p"><?php echo app('translator')->get('index.deposit_withdraw'); ?></th>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($value->accountName ? $value->accountName->name : ''); ?></td>
                                    <td><?php echo e($value->addedBy->name); ?></td>
                                    <td class="ir_txt_center">
                                        <?php if(routePermission('deposit.edit')): ?>
                                            <a href="<?php echo e(url('deposit')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit" class="button-success"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="<?php echo app('translator')->get('index.edit'); ?>"><i class="fa fa-edit tiny-icon"></i></a>
                                        <?php endif; ?>
                                        <?php if(routePermission('deposit.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('deposit.destroy', $value->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/deposit/index.blade.php ENDPATH**/ ?>