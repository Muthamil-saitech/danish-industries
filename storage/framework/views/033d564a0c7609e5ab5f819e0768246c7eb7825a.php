    ...
    <section class="content-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Production Stages: <?php echo e($total_production_stages); ?> </h5>
            </div>
        </div>
    </section>
        ...
        <div class="table-box">
            ...
            <div class="table-responsive">
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            <th class="width_1_p c_center"><?php echo app('translator')->get('index.sn'); ?></th>
                            <th class="width_26_pc_center"><?php echo app('translator')->get('index.production_stage_name'); ?></th>
                            <th class="width_26_pc_center"><?php echo app('translator')->get('index.description'); ?></th>
                            <th class="width_1_p text-start"><?php echo app('translator')->get('index.actions'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-start">
                                <?php if($value->name != 'Cash'): ?>
                                <?php if(routePermission('productionstage.edit')): ?>
                                <a href="<?php echo e(url('productionstages')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit"
                                ...
                                <?php endif; ?>
                                <?php if(routePermission('productionstage.delete') && !$value->used_in_production_stage): ?>
                                <a href="#" class="delete button-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('index.delete'); ?>"
                                    data-form_class="alertDelete<?php echo e($value->id); ?>" type="submit">
                                    <form action="<?php echo e(route('productionstages.destroy', $value->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/productionstage/productionstages.blade.php ENDPATH**/ ?>