    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Material Categories: <?php echo e($total_mat_categories); ?> </h5>
            </div>
        </div>
    </section>
                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="ir_w_25"><?php echo app('translator')->get('index.material_category'); ?></th>
                            <th class="ir_w_16"><?php echo app('translator')->get('index.description'); ?></th>
                            <th class="ir_w_1 text-start not-export-col"><?php echo app('translator')->get('index.actions'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/rmcategory/rmcategories.blade.php ENDPATH**/ ?>