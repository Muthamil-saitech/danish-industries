...
unset($__errorArgs, $__bag); ?> select2" name="mat_cat_id" id="mat_cat_id">
                                    <option value=""><?php echo app('translator')->get('index.select'); ?></option>
                                    <?php $__currentLoopData = $mat_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            <?php echo e((isset($obj->mat_cat_id) && $obj->mat_cat_id == $value->id) || old('mat_cat_id') == $value->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="dc_no" class="form-control" id="dc_no" placeholder="DC No" value="<?php echo e(isset($obj) && $obj->dc_no!='' ? $obj->dc_no : old('dc_no')); ?>">
                                <div class="text-danger d-none"></div>
...
unset($__errorArgs, $__bag); ?>" name="mat_doc_no" id="mat_doc_no" value="<?php echo e(isset($obj->mat_doc_no) && $obj->mat_doc_no ? $obj->mat_doc_no : old('mat_doc_no')); ?>" placeholder="Material Doc No">
                                <div class="text-danger d-none"></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish\resources\views/pages/material_stock/addEditMaterialStock.blade.php ENDPATH**/ ?>