                                    ...
                                    <?php $__currentLoopData = $order_quotation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="card border-bottom mb-2">
                                            <div class="card-body text-left fs-6">
                                                ...
                                                <p>Part Name : <?php echo e($value->name); ?> (<?php echo e($value->code); ?>)</p>
                                                <p><?php echo app('translator')->get('index.total'); ?> : <strong class="text-right"><?php echo e(getAmtCustom(round($value->total_amount))); ?></strong></p>
                                                <p><?php echo app('translator')->get('index.quote_date'); ?> : <strong class="text-right"><?php echo e(getDateFormat($value->created_at)); ?></strong></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish\resources\views/pages/customer_order/order-status.blade.php ENDPATH**/ ?>