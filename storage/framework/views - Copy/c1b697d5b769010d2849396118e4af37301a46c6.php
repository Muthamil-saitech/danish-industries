...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <button id="job_add" data-bs-toggle="modal" data-id="<?php echo e($obj->id); ?>" data-bs-target="#jobUpl" class="btn bg-second-btn" title="Job Card Upload Form" type="button"><i class="fa-regular fa-circle-up"></i>&nbsp;Upload</button>
                ...
                <?php endif; ?>
                <!--<a href="<?php echo e(route('download_job_card', encrypt_decrypt($obj->id, 'encrypt'))); ?>"
    ...
    <div style="width: 98%; max-width: 1100px; margin: 30px auto;">
        ...
        <img src="<?php echo e($baseURL); ?>uploads/job_card_form/<?php echo e($latest_form); ?>" alt="route_card_form" class="img-fluid">
    </div>
    <?php else: ?>
    <div style="width: 98%; max-width: 1100px; margin: 30px auto; font-family: Arial, sans-serif;  padding: 18px;">
        <div style="text-align: center;">
            <img src="<?php echo getBaseURL() .
                        (isset(getWhiteLabelInfo()->logo) ? 'uploads/white_label/' . getWhiteLabelInfo()->logo : 'images/logo.png'); ?>" alt="Logo Image" class="img-fluid mb-2">
            <!-- <h3 style="margin: 0; font-size: 22px;"><?php echo e(strtoupper($setting->name_company_name)); ?></h3> -->
            <p style="font-size: 14px; margin-bottom: 10px"><?php echo e(strtoupper($setting->address)); ?></p>
        </div>
        <h3 style="text-align: center; margin-bottom: 10px; font-size: 18px;"><?php echo e(isset($title) && $title ? strtoupper($title) : ''); ?></h3>
...
<script>
    ...
    $('#job_upload_form').on('submit', function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('job-card-upload')); ?>",
            method: "POST",
            data: formData,
            contentType: false,
            processData: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish\resources\views/pages/manufacture/job_card.blade.php ENDPATH**/ ?>