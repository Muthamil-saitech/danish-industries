    ...
    <section class="content-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end">
                <h5 class="">Total Salary Report: <?php echo e(isset($obj) && $obj ? count($obj) : '0'); ?></h5>
            </div>
        </div>
    </section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish-industries\resources\views/pages/report/salary_report.blade.php ENDPATH**/ ?>