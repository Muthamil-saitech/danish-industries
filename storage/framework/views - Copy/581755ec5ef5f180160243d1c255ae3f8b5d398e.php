                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="ir_w_16"><?php echo app('translator')->get('index.part_name'); ?> (<?php echo app('translator')->get('index.part_no'); ?>)</th>
                            ...
                            <?php if($manufactures && !empty($manufactures)): ?>
                                <?php $__currentLoopData = $manufactures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(getFinishProduct($value->product_id)); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\danish\resources\views/pages/inspection/inspectionGenerate.blade.php ENDPATH**/ ?>