...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::middleware(['auth','set_locale', 'has_permission', 'is_first_login'])->group(function () {
        ...
        Route::post('/updateOrderStatus', [App\Http\Controllers\AjaxController::class, 'updateOrderStatus'])->name('updateOrderStatus');
        Route::post('/updatePurchaseStatus', [App\Http\Controllers\RawMaterialPurchaseController::class, 'updatePurchaseStatus'])->name('updatePurchaseStatus');
        Route::post('/updateSupplierPayStatus', [App\Http\Controllers\SupplierPaymentController::class, 'updateSupplierPayStatus'])->name('updateSupplierPayStatus');
        Route::post('/updateQCStatus', [App\Http\Controllers\ProductionController::class, 'updateQCStatus'])->name('updateQCStatus');
        // Route::post('/updatePayType', [App\Http\Controllers\CustomerPaymentController::class, 'updatePayType'])->name('updatePayType');
        Route::post('/customer-due-entry', [App\Http\Controllers\CustomerPaymentController::class, 'customerDueEntry'])->name('customer-due-entry');
        Route::post('/supplier-pay-entry', [App\Http\Controllers\SupplierPaymentController::class, 'supplierPayEntry'])->name('supplier-pay-entry');
        Route::post('/updateMoveStatus', [App\Http\Controllers\ProductionController::class, 'updateMoveStatus'])->name('updateMoveStatus');
        Route::post('/updateVerifiedStatus', [App\Http\Controllers\QuotationController::class, 'updateVerifiedStatus'])->name('updateVerifiedStatus');
        Route::post('/updateChallanStatus', [App\Http\Controllers\QuotationController::class, 'updateChallanStatus'])->name('updateChallanStatus');
        Route::post('/getMaterialStockByType', [App\Http\Controllers\AjaxController::class, 'getMaterialStockByType'])->name('getMaterialStockByType');
        Route::post('/getStockReference', [App\Http\Controllers\AjaxController::class, 'getStockReference'])->name('getStockReference');
        ...
        Route::post('/getQCAssignLog', [App\Http\Controllers\ProductionController::class, 'getQCAssignLog'])->name('getQCAssignLog');
        Route::post('/getDCQCAssignLog', [App\Http\Controllers\QuotationController::class, 'getDCQCAssignLog'])->name('getDCQCAssignLog');
        ...
        Route::get('/getCustomerDetail', [App\Http\Controllers\AjaxController::class, 'getCustomerDetail'])->name('getCustomerDetail');
        Route::get('/getMaterialCode', [App\Http\Controllers\InspectionController::class, 'getMaterialCode'])->name('getMaterialCode');
        ...
        Route::post('getTaxRate', [App\Http\Controllers\AjaxController::class, 'getTaxRate'])->name('getTaxRate.post');
        Route::post('getChallanDetails', [App\Http\Controllers\AjaxController::class, 'getChallanDetails'])->name('getChallanDetails.post');
        ...
        Route::get('/productions/{coid}/{pid}/create', [App\Http\Controllers\ProductionController::class, 'create']);
        Route::get('/productions/{fproducts}/duplicate', [App\Http\Controllers\ProductionController::class, 'duplicate']);
        Route::get('/productions/{mid}/route-card', [App\Http\Controllers\ProductionController::class, 'route_card']);
        Route::get('/productions/{mid}/job-card', [App\Http\Controllers\ProductionController::class, 'job_card']);
        ...
        Route::get('/print_route_card_detail/{id}', [App\Http\Controllers\ProductionController::class, 'printRouteCardDetails'])->name('print_route_card_detail');
        Route::get('/download_route_card/{id}', [App\Http\Controllers\ProductionController::class, 'downloadRouteCard'])->name('download_route_card');
        Route::get('/print_job_card_detail/{id}', [App\Http\Controllers\ProductionController::class, 'printJobCardDetails'])->name('print_job_card_detail');
        Route::get('/download_job_card/{id}', [App\Http\Controllers\ProductionController::class, 'downloadJobDetails'])->name('download_job_card');
        ...
        Route::post('/updateQcScheduling', [App\Http\Controllers\ProductionController::class, 'updateQcScheduling'])->name('updateQcScheduling');
        Route::post('/updateDcQcAssign', [App\Http\Controllers\QuotationController::class, 'updateDcQcAssign'])->name('updateDcQcAssign');
        Route::post('/route-card-upload', [App\Http\Controllers\ProductionController::class, 'routeCardSubmit'])->name('route-card-upload');
        Route::post('/job-card-upload', [App\Http\Controllers\ProductionController::class, 'jobCardSubmit'])->name('job-card-upload');

        /* Consumable */
        Route::resource('consumable', App\Http\Controllers\ConsumableController::class);

        /* Inspection */
        Route::resource('inspection-generate', App\Http\Controllers\InspectionGeneratorController::class);
        Route::get('/print_inspection/{id}', [App\Http\Controllers\InspectionGeneratorController::class, 'printInspectionDetail'])->name('print_inspection');
        Route::get('/download_inspection_report/{id}', [App\Http\Controllers\InspectionGeneratorController::class, 'downloadInspectReport'])->name('download_inspection_report');
        Route::post('/getInspectionParams', [App\Http\Controllers\InspectionGeneratorController::class, 'getInspectionParams'])->name('inspect.getInspectionParams');
        Route::post('/updateInspectionDimension', [App\Http\Controllers\InspectionGeneratorController::class, 'updateInspectionDimension'])->name('inspect.updateInspectionDimension');
        Route::post('/updateInspectionApproval', [App\Http\Controllers\InspectionGeneratorController::class, 'updateInspectionApproval'])->name('updateInspectionApproval');
        Route::post('/inspection-report-upload', [App\Http\Controllers\InspectionGeneratorController::class, 'inspectionReportFileSubmit'])->name('inspection-report-upload');
        ...
        Route::get('/supplier-payment-view/{id}', [App\Http\Controllers\SupplierPaymentController::class, 'supplierEntry'])->name('supplier-payment-view');
        ...
        Route::get('/customer-payment-view/{id}', [App\Http\Controllers\CustomerPaymentController::class, 'dueEntry'])->name('customer-payment-view');
        ...
        Route::get('sale-report', [App\Http\Controllers\ReportController::class, 'salesReport'])->name('report.sales');
