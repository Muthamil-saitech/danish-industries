                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_10_p">@lang('index.quotation_no')</th>
                                <th class="width_10_p">@lang('index.customers') (@lang('index.code'))</th>
                                <th class="width_10_p">@lang('index.quote_date')</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($obj as $value)
                                <tr>
                                    ...
                                    <td>{{ getDateFormat($value->quote_date) }}</td>
                                    ...
                                    <td class="text-start">
                                        ...
                                        @if (routePermission('quotation.edit'))
                                        ...
                                        @endif
                                        @if (routePermission('quotation.delete'))
