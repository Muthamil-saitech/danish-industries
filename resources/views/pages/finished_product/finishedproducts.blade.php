    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Products: {{ $total_finished_products }} </h5>
            </div>
        </div>
    </section>
                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="width_10_p">@lang('index.product_category')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td title="{{ $value->remarks }}">{{ $value->remarks!='' ? substr_text($value->remarks,20) : 'N/A' }}</td>
                            ...
                            <td class="text-start">
                                ...
                                @endif
                                @if (routePermission('product.delete') && !$value->used_in_order)
