...
<body>
    <div class="m-auto b-r-5 p-30">
        ...
        <table class="w-100 mt-20 order_details" style="border: 1px solid #000;">
            <thead class="b-r-3">
                <tr>
                    ...
                    <th class="w-5 text-start" style="border:1px solid #000;">@lang('index.po_date')</th>
                    <th class="w-15 text-start" style="border:1px solid #000;">@lang('index.part_no')</th>
                    <th class="w-20 text-start" style="border:1px solid #000;">@lang('index.part_name')</th>
                    <th class="w-30 text-start" style="border:1px solid #000;">@lang('index.raw_material_name')<br>(@lang('index.code'))</th>
                    {{-- <th class="w-25 text-start">Heat No</th> --}}
                    <th class="w-5 text-center" style="border:1px solid #000;">@lang('index.raw_quantity')</th>
                    <th class="w-5 text-center" style="border:1px solid #000;">@lang('index.prod_quantity')</th>
                    ...
                    <th class="w-15 text-center" style="border:1px solid #000;">@lang('index.tax')</th>
                    <th class="w-15 text-center" style="border:1px solid #000;">@lang('index.total')</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="rowCount" data-id="{{ $value->product_id }}">
                    ...
                    ?>
                    <td class="text-start" style="border:1px solid #000; font-family: DejaVu Sans, sans-serif;">₹{{ number_format($gst_value,2) }}
                    </td>
        ...
        <table class="w-100 mt-10">
            <thead class="b-r-3 bg-transparent">
                <tr>
            ...
            <table class="w-100 mt-10">
                ...
                <tbody>
                    ...
                    @foreach ($orderDeliveries as $key => $value)
                        ...
                        ?>
                        <tr class="rowCount">
                            <td class="width_1_p"><p class="set_sn">{{ $i++ }}</p>
        </td>
