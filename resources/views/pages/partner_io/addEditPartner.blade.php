                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                <select name="" id="customer_id" class="form-control select2">
                                    ...
                                    <option value="Nisha(P002)">Nisha(P002)</option>
                                </select>
                                <div class="error_alert text-danger">
                                    {{ $errors->first('po_no') }}
                                </div>
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                               <label>Phone Number </label>
                                <input type="text" name="cp_phn_no[]" class="form-control" placeholder="Phone Number" value="7458961231">
                            </div>
                        </div>
                         <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                               <label>Email </label>
                                <input type="text" name="cp_email[]" class="form-control" placeholder="Email" value="kishore@gmail.com">
                            </div>
                        </div>
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                               <label>Delivery Address </label>
                                <textarea name="d_address[]" id="d_address" class="form-control" rows="3">41/A, Jaihindpuram, Madurai.</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
