    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Material Types: {{ isset($total_mat_types) ? $total_mat_types : '0' }} </h5>
            </div>
        </div>
    </section>
                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="ir_w_25">@lang('index.mat_types')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-start">
                                @if (routePermission('materialtype.edit'))
                                <a href="{{ url('materialtypes') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/edit"
                                    class="button-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="@lang('index.edit')"><i class="fa fa-edit tiny-icon"></i></a>
                                @endif
                                @if (routePermission('materialtype.delete'))
                                <a href="#" class="delete button-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <form action="{{ route('materialtypes.destroy', $value->id) }}"
