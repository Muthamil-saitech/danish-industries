                ...
                <div>
                    <div class="row">
                        {{-- <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <label>@lang('index.purchase_no') <span class="required_star">*</span></label>
                                <input type="text" name="reference_no" id="reference_no"
                                    class="check_required form-control @error('reference_no') is-invalid @enderror"
                                    placeholder="@lang('index.purchase_no')"
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="w-100">
                                        <select tabindex="2" class="form-control @error('supplier') is-invalid @enderror select2" id="supplier_id" name="supplier">
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <label>@lang('index.purchase_date') <span class="required_star">*</span></label>
                                <input type="text" class="form-control @error('date') is-invalid @enderror" disabled
                                    placeholder="Date" value="{{ isset($obj->date) ? date('d-m-Y',strtotime($obj->date)) : (old('date') ?? date('d-m-Y')) }}">
                                <input type="hidden" name="date" class="form-control @error('date') is-invalid @enderror" 
                                placeholder="Purchase Date" value="{{ isset($obj->date) ? $obj->date : (old('date') ?? date('d-m-Y')) }}">
                                <div class="text-danger d-none"></div>
                                @error('date')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                {{-- <select multiple class="form-control @error('purchase_mat_type') is-invalid @enderror select2" name="mat_type[]" id="purchase_mat_type">
                                    ...
                                    <option {{ (collect(old('mat_type', isset($obj->mat_type) ? explode(',', $obj->mat_type) : []))->contains("3")) ? 'selected' : '' }} value="3">Insert</option>
                                </select> --}}
                            ...
                            <div class="form-group">
                                ...
                                <select tabindex="4"
                                    ...
                                    {{-- @foreach ($rmaterials as $rm)
                                        <option
                                            value="{{ $rm->id . '|' . $rm->name . ' (' . $rm->code . ')|' . $rm->name }}">
                                            ...
                                            @foreach ($pruchse_rmaterials as $key => $value)
                                                <tr class="rowCount" data-id="{{ $value->rmaterials_id }}">
                                                    ...
                                                    <td><input type="hidden" value="{{ $value->rmaterials_id }}"
                                                            name="rm_id[]">
                                                        <span>{{ getRMName($value->rmaterials_id) }}<br><small>{{ getInsertType($value->rmaterials_id) }}</small></span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="hidden" value="{{ $value->mat_unit }}"
                                                            name="mat_unit[]">
                                                            ...
                                                            <span
                                                                class="input-group-text">{{ getRMUnitById($value->mat_unit ? $value->mat_unit : 1) }}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-3">
                            ...
                            {{-- <div class="row mb-1">
                                <label class="custom_label">@lang('index.account')</label>
                                <div class="d-flex align-items-center">
                                    <div class="w-100">
                                        <select tabindex="2"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <label class="col-sm-12 control-label custom_label mb-1">@lang('index.unit') <span
                                        class="required_star">*</span></label>
                                <div class="col-sm-12">
