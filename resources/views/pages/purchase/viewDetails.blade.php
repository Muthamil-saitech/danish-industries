                            ...
                            <table>
                                <tr>
                                    <td class="w-50">
                                        ...
                                        @if($suppliers[0]->contact_person!='')<p class="pb-7 rgb-71">{{ $suppliers[0]->contact_person }}</p> @endif
                                        <p class="pb-7 rgb-71">{{ $suppliers[0]->phone }}</p>
                                        @if($suppliers[0]->gst_no!='')<p class="pb-7 rgb-71">{{ $suppliers[0]->gst_no }}</p> @endif
                                        @if($suppliers[0]->email!='')<p class="pb-7 rgb-71">{{ $suppliers[0]->email }}</p> @endif
                                        @if($suppliers[0]->address!='')<p class="pb-7 rgb-71">{{ $suppliers[0]->address }}</p>@endif
                                    </td>
                                    <td class="w-50 text-right">
                                    ...
                                    @if (isset($pruchse_rmaterials) && $pruchse_rmaterials)
                                        ...
                                        @foreach ($pruchse_rmaterials as $key => $value)
                                            <tr class="rowCount" data-id="{{ $value->finishProduct_id }}">
                                                ...
                                                {{-- <td class="text-center">{{ getheatNo($value->rmaterials_id) }}</td> --}}
                                    ...
                                    <td class="w-50">
                                        <table>
                                            <tr>
                                                ...
                                                <td class="w-50 text-right pr-0">
                                                    <p>{{ getAmtCustom(safe_integer($obj->subtotal)) }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                        <table>
                                            <tr>
                                                ...
                                                <td class="w-50 text-right pr-0">
                                                    <p>{{ getAmtCustom(safe_integer($obj->other)) }} </p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td class="w-50 text-right pr-0">
                                                    <p>{{ getAmtCustom(safe_integer($obj->discount)) }} </p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="mt-10 mb-10">
                                            <tr>
                                                ...
                                                <td class="w-50 text-right pr-0">
                                                    <p>{{ getAmtCustom(safe_integer($obj->grand_total)) }} </p>
                                                </td>
                                            </tr>
                                        </table>
                                        <table>
                                            <tr>
                                                ...
                                                <td class="w-50 text-right pr-0">
                                                    <p>{{ getAmtCustom(safe_integer($obj->paid)) }} </p>
                                                </td>
                                            </tr>
                                        </table>
                                        {{-- <table>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td class="w-50 text-right pr-0">
                                                    <p>{{ getAmtCustom(safe_integer($obj->due)) }} </p>
                                                </td>
                                            </tr>
                                        </table>
