...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Productions: {{ $total_productions }} </h5>
            </div>
        </div>
    </section>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('productions') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/route-card" style="text-decoration: none"
                                    class="button-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="@lang('index.route_card')">
                                    <i class="fa fa-route"></i>
                                </a>
                                <a href="{{ url('productions') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/job-card" style="text-decoration: none"
                                    class="button-info" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="@lang('index.job_card')">
                                    <i class="fa fa-user-tie"></i>
                                </a>
                                <a href="{{ url('productions') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/task-track" style="text-decoration: none"
                                    class="button-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                @endif --}}
                                @if($value->drawer_no!= null && $value->drawer_no != '')
                                <a href="{{ url('productions') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/drawer-image" class="button-info" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('index.view_drawer_img')"><i class="fa fa-image"></i>
                                </a>
                                @endif
                                @if ($value->manufacture_status != 'done')
    ...
    <div class="modal fade" id="filterModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('index.manufactures')</h5>
