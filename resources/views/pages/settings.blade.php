                            ...
                            <div class="row">
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_company_name"
                                            ...
                                            id="name_company_name" placeholder="@lang('index.company_name')"
                                            value="{{ isset($settingsInfo->name_company_name) && $settingsInfo->name_company_name ? $settingsInfo->name_company_name : old('name_company_name') }}">
                                ...
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contact_person"
                                            ...
                                            id="contact_person" placeholder="@lang('index.contact_person')"
                                            value="{{ isset($settingsInfo->contact_person) && $settingsInfo->contact_person ? $settingsInfo->contact_person : old('contact_person') }}">
                                ...
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone"
                                            ...
                                            id="phone" placeholder="@lang('index.phone')"
                                            value="{{ isset($settingsInfo->phone) && $settingsInfo->phone ? $settingsInfo->phone : old('phone') }}">
                                        @error('phone')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email"
                                            ...
                                            placeholder="Email"
                                            value="{{ isset($settingsInfo->email) && $settingsInfo->email ? $settingsInfo->email : old('email') }}">
                                ...
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="web_site"
                                            ...
                                            placeholder="Website"
                                            value="{{ isset($settingsInfo->web_site) && $settingsInfo->web_site ? $settingsInfo->web_site : old('web_site') }}">
                                        @error('web_site')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" cols="50" rows="3" placeholder="@lang('index.address')">{{ isset($settingsInfo->address) && $settingsInfo->address ? $settingsInfo->address : old('address') }}</textarea>
                                        @error('address')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="gst_no"
                                            ...
                                            id="gst_no" placeholder="@lang('index.gst_no')"
                                            value="{{ isset($settingsInfo->gst_no) && $settingsInfo->gst_no ? $settingsInfo->gst_no : old('gst_no') }}">
                                        @error('gst_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="pan_no"
                                            ...
                                            value="{{ isset($settingsInfo->pan_no) && $settingsInfo->pan_no ? $settingsInfo->pan_no : old('pan_no') }}">
                                        @error('pan_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label>@lang('index.ssi_no') </label>
                                        <input type="text" name="ssi_no"
                                            class="form-control @error('ssi_no') is-invalid @enderror"
                                            id="ssi_no" placeholder="@lang('index.ssi_no')"
                                            value="{{ old('ssi_no', $settingsInfo->ssi_no ?? '') }}">
                                        @error('ssi_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
