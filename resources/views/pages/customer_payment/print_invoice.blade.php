        ...
        <table class="w-100 mt-20">
            <thead class="b-r-3 bg-color-000000">
                <tr>
                    ...
                    <th class="w-30 text-start">@lang('index.note')</th>
                    <th class="w-20 text-start">@lang('index.payment_img')</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                <tr class="rowCount" data-id="{{ $customer_due->id }}">
                    ...
                    <td class="text-start">{{ $customer_due->note }}
                    </td>
                    <td class="text-start">
