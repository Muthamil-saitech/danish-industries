                        ...
                        <tbody>
                            ...
                            @foreach ($obj as $key => $value)
                                <tr>
                                    ...
                                    <td><h6>@if($value->orderInvoice->due_amount==0.00) <span class="badge bg-success">Paid</span> @elseif($value->orderInvoice->paid_amount==0.00) <span class="badge bg-danger">Unpaid</span> @else <span class="badge bg-info">Partially Paid</span>@endif</h6></td>
                                    <td class="text-end">
