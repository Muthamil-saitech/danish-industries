    ...
    <section class="content-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Units: {{ $total_units }} </h5>
            </div>
        </div>
    </section>
                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="ir_w_16">@lang('index.unit_name')</th>
                            <th class="ir_w_25">@lang('index.description')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-start">
                                ...
                                @endif
                                @if (routePermission('units.delete') && !$value->used_in_purchase)
