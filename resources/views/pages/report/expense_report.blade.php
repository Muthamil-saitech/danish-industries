        ...
        <div class="row">
            <div class="col-sm-12 mb-3 col-md-4 col-lg-2">
                <div class="form-group">
                    {!! Form::text('startDate', $startDate, ['class' => 'form-control', 'readonly'=>"", 'placeholder'=>"Start Date", 'id' => 'exp_start_date']) !!}
                </div>
            </div>
            <div class="col-sm-12 mb-3 col-md-4 col-lg-2">
                <div class="form-group">
                    {!! Form::text('endDate', $endDate, ['class' => 'form-control', 'readonly'=>"", 'placeholder'=>"End Date", 'id' => 'exp_complete_date']) !!}
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-2 col-lg-2">
                <div class="form-group">
                    <a href="{{ route('expense-report') }}" style="text-decoration: none;color:white;"><button type="button" value="reset" class="btn bg-second-btn w-100">Reset</button></a>
                </div>
            </div>
        </div>
        {!! Form::close() !!}
