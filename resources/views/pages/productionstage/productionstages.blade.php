    ...
    <section class="content-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Production Stages: {{ $total_production_stages }} </h5>
            </div>
        </div>
    </section>
                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="width_26_pc_center">@lang('index.production_stage_name')</th>
                            <th class="width_26_pc_center">@lang('index.description')</th>
                            <th class="width_1_p text-start">@lang('index.actions')</th>
                        </tr>
                    </thead>
                    <tbody>
                        @if ($obj && !empty($obj))
                        ...
                        <tr>
                            ...
                            <td class="text-start">
                                ...
                                @endif
                                @if (routePermission('productionstage.delete') && !$value->used_in_production_stage)
                                <a href="#" class="delete button-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('index.delete')"
