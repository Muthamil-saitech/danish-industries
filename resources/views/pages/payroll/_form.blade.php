            ...
            <table id="datatable" class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <th class="width_10_p"></th>
                        <th class="width_10_p"></th>
                        <th class="width_10_p" colspan="2">@lang('index.total') = <span class="total_amount"></span><input type="hidden" id="total_amount" name="total_amount" value="{{ isset($obj) ? $obj->total_amount : 0 }}"></th>
                        {{-- <th class="width_15_p"></th> --}}
                    </tr>
